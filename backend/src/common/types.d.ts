...
type IMihomoMixedGroup = Omit<IMihomoGroup, 'all'> & {
...
interface IMihomoConfig {
  ...
  'geox-url'?: { geoip?: string; geosite?: string; mmdb?: string; asn?: string }
  ...
  'proxy-providers'?: Record<string, IMihomoProxyProvider>
  'rule-providers'?: Record<string, IMihomoRuleProvider>
  proxies?: IMihomoProxy[]
  'proxy-groups'?: IMihomoGroup[]
  rules?: string[]
}
