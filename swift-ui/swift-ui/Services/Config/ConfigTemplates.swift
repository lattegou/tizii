...
enum ConfigTemplates {
    // NOTE: Keep template keys aligned with backend/src/utils/template.ts.
    nonisolated static let defaultAppConfigYAML = """
core: mihomo
...
"""
    ...
    nonisolated static let defaultControledMihomoConfigYAML = """
external-controller: ""
ipv6: true
mode: rule
mixed-port: 7890
...
"""
    ...
    nonisolated static let defaultProfileConfigYAML = """
items: []
"""

    nonisolated static let defaultOverrideConfigYAML = """
items: []
"""

    nonisolated static let defaultProfileYAML = """
proxies: []
proxy-groups: []
rules: []
"""
